...
public class formMouseClicked extends javax.swing.JFrame {

   
    public formMouseClicked() {
        initComponents();
...
menuEmergente.show(this,evt.getX(),evt.getY()) ;      // TODO add your handling code here:
 ...
 this.getContentPane().setBackground(Color.BLUE);        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formMouseClicked.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new formMouseClicked().setVisible(true);
            }
        });
    }
